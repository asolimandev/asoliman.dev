module.exports = {
  siteMetadata: {
    ...
    volunteering: [
      {
        name: 'Software Developer | Egyptian Armed Forces',
        description: 'Aug 2020 - Sep 2021, My military service allowed me to utilize my software development skills to support operations while gaining valuable military training, fostering discipline, teamwork, and respect for authority.',
        link: '',
      },
      {
        name: 'Volunteer Tech Instructor | Resala Charity Organization',
        description: 'Jan 2020 - Jul 2020, Responsible for planning, teaching, and supporting technology courses, collaborating with volunteers, tracking learner progress, and engaging in professional development opportunities.',
        link: '',
      },
      {
        name: 'Event Organizer | IEEE AAST Alexandria Student Branch',
        description: 'Feb 2018 - Sep 2019, I organized and facilitated workshops, volunteered at LYC events, and collaborated with the IEEE team to develop our branch website from scratch.',
        link: '',
      },
      {
        name: 'Head of Scientific Section in Student Council | AAST',
        description: 'Sep 2017 - Aug 2018, I collaborated with council members to organize events promoting scientific education, mentored students, and developed valuable leadership and organizational skills.',
        link: '',
      },
      {
        name: 'Student Volunteer | Bibliotheca Alexandrina',
        description: 'May 2015 - Sep 2016, I participated in YESBU and LYM programs, attending weekly meetings and presenting on scientific and cultural topics to enhance youth capacity and raise awareness on environmental and scientific issues.        ',
        link: '',
      },
      {
        name: 'Hospital Volunteer | King Fahad Medical City - KFMC',
        description: 'May 2014 - Aug 2014, Assisting with administrative tasks, visiting patients, and helping with events and fundraisers.',
        link: '',
      },
      {
        name: 'Head of Student Council | Al-Sulaymaniyah Secondary SchoolAl',
        description: 'Sep 2013 - Aug 2014, I organized diverse events and initiatives, implemented programs to improve academics, and gained valuable leadership and teamwork skills for future endeavors.',
        link: '',
      },
    ],
  },
